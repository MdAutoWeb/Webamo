    ...
    try {
      const res = await fetch("/api/leads/process", {
        ...
        body: JSON.stringify({
          ...
          situatie: form.bericht,
          websiteTrap: form.websiteTrap,
        }),
      });
      ...
      if (!res.ok) {
        setErrorMsg(data.error ?? "Er liep iets mis. Probeer opnieuw of mail naar info@webamo.be.");
        setStatus("error");
        return;
      }
      ...
      setErrorMsg("Er liep iets mis. Probeer opnieuw of mail naar info@webamo.be.");
      setStatus("error");
    }
  }
      ...
      <section className="max-w-[1120px] mx-auto px-5 pt-16 pb-12 md:pt-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        <div>
          ...
          <p className="text-[15px] text-[#6B7280] leading-[1.65] mb-8 max-w-[400px]">
            We bekijken samen wat er ontbreekt en hoe snel we dat kunnen oplossen. Geen
            verplichtingen.
          </p>
          ...
          <ul className="space-y-4 text-[14px] text-[#374151]">
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+32493527360" className="hover:text-[#2563EB] transition-colors">
                +32 493 527 360
              </a>
            </li>
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:info@webamo.be" className="hover:text-[#2563EB] transition-colors">
                info@webamo.be
              </a>
            </li>
            <li className="flex items-center gap-3">
          ...
          {status === "success" ? (
            ...
            <form onSubmit={submit} className="space-y-4">
              <input
                ...
                onChange={(e) => set("websiteTrap", e.target.value)}
                className="hidden"
                tabIndex={-1}
                autoComplete="off"
                aria-hidden
              ...
              <div>
                <label className="block text-[12px] font-medium text-[#374151] mb-1" htmlFor="naam">
                  Naam *
                </label>
                <input
                  id="naam"
              ...
              <div>
                <label className="block text-[12px] font-medium text-[#374151] mb-1" htmlFor="email">
                  E-mail *
                </label>
                <input
                  id="email"
              ...
              <div>
                <label className="block text-[12px] font-medium text-[#374151] mb-1" htmlFor="bericht">
                  Bericht
                </label>
                <textarea
                  id="bericht"
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center font-medium transition-colors bg-[#2563EB] text-white hover:bg-[#1E54CE] px-5 py-[13px] text-[15px] rounded-[10px] disabled:opacity-60"
              >
